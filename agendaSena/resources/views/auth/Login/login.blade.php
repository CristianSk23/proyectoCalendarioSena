...
<div class="font-[sans-serif] bg-gray-900 md:h-screen">
    <div class="grid md:grid-cols-2 items-center gap-8 h-full">
        <div class="max-md:order-1 p-4">
            <img src="{{ asset('css/loginResources/login_sena2.jpg') }}"
                class="lg:max-w-[100%] w-full h-full object-contain block mx-auto" alt="login-image" />
        </div>

        <div class="flex items-center md:p-8 p-6 bg-white md:rounded-tl-[55px] md:rounded-bl-[55px] h-full">
            <form class="max-w-lg w-full mx-auto" method="POST" action="{{ route('login.ingresar') }}">
                @csrf
                <div class="mb-12">
                    <h3 class="text-gray-800 text-4xl font-extrabold">Ingresar</h3>
                    <p class="text-gray-800 text-sm mt-4 ">¿No tienes una cuenta? <a href="javascript:void(0);"
                            class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Registrar</a>
                    </p>
                </div>
