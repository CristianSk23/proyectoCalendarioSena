...
document.getElementById('btnFullscreenBanner').addEventListener('click', () => {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const btn = document.getElementById('btnFullscreenBanner');
...
<script>
    ...
    document.getElementById('showPublicModal').addEventListener('hide.bs.modal', function () {
    document.activeElement.blur(); // Elimina el foco de cualquier botón dentro del modal
});
