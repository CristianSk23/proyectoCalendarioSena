...
@push('scripts')
    ...
    function convertirURLsEnEnlaces(texto) {
        ...
        function openModal(event) {
            ...
            fetch(`/eventos/${event.idEvento}/visualizar`, {
                method: 'POST',
                headers: {
                ...
                .then(data => console.log('Visualización registrada:', data))
...
{{-- ${participante.par_nombres ? `<li><strong>👤 Solicitante:</strong> ${participante.par_nombres}
    ${participante.par_apellidos}</li>` : ''} --}}