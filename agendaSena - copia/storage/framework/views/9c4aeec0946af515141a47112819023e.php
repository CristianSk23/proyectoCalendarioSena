...
<?php $__env->startSection('content'); ?>
    <!-- <div class="container mx-auto mt-10">
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    <div class="mt-6">
                                                                                                                                                                                                                                                        <a href="<?php echo e(route('eventos.index')); ?>" class="bg-blue-500 text-white px-4 py-2 rounded mr-4">Ver Eventos</a>
                                                                                                                                                                                                                                                        <a href="<?php echo e(route('horarios.index')); ?>" class="bg-green-500 text-white px-4 py-2 rounded">Ver Horarios</a>
                                                                                                                                                                                                                                                    </div>
                                                                                                                                                                                                                                                </div> -->
    ...
    <script>
        ...
        `;
            ...
            function agregarEvento(dia, mes, anio) {
                ...
                const baseRuta = "<?php echo e(route('eventos.buscar')); ?>"; // Genera la base de la ruta
                ...
                `;
                            const baseRutaCrearEvento = "<?php echo e(route('eventos.crearEvento')); ?>";
    ...
    <div class="text-center mb-4">
            <a href="<?php echo e(route('evento.reportes.index')); ?>" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 transition duration-200">
                Ver Reportes
            </a>
        </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('Layouts.Plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MI PC\Documents\GitHub\proyectoCalendarioSena\agendaSena\resources\views/index.blade.php ENDPATH**/ ?>